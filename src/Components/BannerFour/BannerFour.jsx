...
export default function BannerFour({paraOne, paraTwo, paraThree, paraFour, title}) {
  return (
    <>
      <div className="bannerTwoCont">
        <div className="bannerTwoUp">
          <div className="bannerTwoUpLeft">
           { title && <span className="visionDet" style={{ letterSpacing: "2px" }}>
              <span className="vdet" style={{ color: "red" }}>
                -
              </span>{" "}
              We Love What we do
            </span>}
            {title && <h4 className="visionDownLeftDes" style={{ marginTop: "20px" }}>
              The next generation can access quality healthcare and great
              education.
            </h4>}
            { title && <p style={{ marginTop: "20px" }}>
      ...
      <div className="bannerFourCont">
        <Stack direction={"column"} spacing={4} className="bannerFourWrap">
          ...
          { title && <h4 className="bannerFourTitle">Educational Tool</h4>}
