    ...
    <>
      <div className="bannerTwoCont">
        <div className="bannerTwoUp">
          ...
          <div className="bannerTwoUpLeft">
            <p>
              We offer a streamlined process designed to simplify the steps for
            ...
            <p>
              ...
              through the work of volunteers. Our volunteers are fundamental to
        ...
        <div className="bannerTwoDown">
          <div className="bannerTwoDownBox ">
            ...
            <p className="bannerTwoDownBoxNameDesc">
              We are dedicated and committed in ensuring that no one goes to bed
              hungry
            </p>
          </div>
          <div className="bannerTwoDownBox">
          ...
          <div className="bannerTwoDownBox">
            ...
            <p className="bannerTwoDownBoxNameDesc">
              We partner with other (NGOs ,Agencies, and Corporate bodies) who
              share our goal of zero hunger initiative
            </p>
          </div>
          <div className="bannerTwoDownBox">
            ...
            <p className="bannerTwoDownBoxNameDesc">
              We are open and accountable to every resources committed into our
              care.
            </p>
          </div>
          <div className="bannerTwoDownBox">
            ...
            <p className="bannerTwoDownBoxNameDesc">
              ...
              with the aim of advancing our mission as effectively as possible.
            </p>
          </div>
        </div>
